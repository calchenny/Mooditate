...
var x = setInterval(function() {
    ...
    $.get( "countdown.html", null, function(text) {
      $( ".result" ).html( data );
      alert( "Load was performed." );
    
    // Get today's date and time
    var now = new Date().getTime();
    document.getElementById("CDtime").innerHTML = now;
    ...
    document.getElementById("CDtime").innerHTML = minutes + "m " + seconds + "s ";
  });
    // If the count down is over, write some text 
    if (distance < 0) {
      clearInterval(x);
      document.getElementById("CDtime").innerHTML = "Your meditation is over";
    }
